...
Im beigefügten Excel-Spreadsheet dokumentiert die Mappe **CC-Lizenzen** je Artikel das Ergebnis der Überprüfung.
...
glue::glue(
  ...
  Im beigefügten Excel-Spreadsheet dokumentiert die Mappe **TDM** die Crossref-Metadaten über Möglichkeiten für das Text und Data Mining je Artikel"
)
```
...
glue::glue(
  ...
  Im beigefügten Excel-Spreadsheet dokumentiert die Mappe **Förderinformationen** Crossref-Metadaten über das *Funding Acknowledgement* je Artikel"
)
```
