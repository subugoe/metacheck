...
metacheck:::report_metacheckable(tabulate_metacheckable(params$dois))
```

Weitere Informationen zu den oben stehenden Kriterien finden Sie in der [Dokumentation](https://subugoe.github.io/metacheck/reference/tabulate_metacheckable.html) (gegenwärtig nur auf Englisch).

Der folgende Bericht bezieht sich daher auf die verbleibenden **`r sum(is_metacheckable(params$doi), na.rm = TRUE)`** DOIs.
