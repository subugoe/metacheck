...
```{r not_indexed_in_crossref, eval=cr_missing, echo=FALSE, results = 'asis'}
  glue::glue("
 Crossref indexes metadata for **{length(unique(cr$doi))}** out of  **{ length(unique(params$dois))}** DOIs. **We could not retrieve metadata from Crossref for the following DOIs:**
