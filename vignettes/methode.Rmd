...
Aus diesem Grunde ist die Überprüfung der Metadaten ein wesentlicher Workflow-Bestandteil beim Umgang mit Open-Access-Publikationskosten und Transformationsverträgen.
...
Er richtet sich in erster Linie an Bibliotheken und wissenschaftlicheInformationseinrichtungen, die Open-Access-Publikationskosten etwa im Rahmen eines Publikationsfonds oder eines Transformationsvertrags verwalten.
...
Daher greifen vielfältige Forschungsvorhaben, Discovery- und Data-Analytics-Serivces auf die Crossref-Datendienste zu, um Open-Access-Artikel zu finden und nachzunutzen.
...
Crossref im Kontext von OA-Transformationsverträgen finden Sie bei @Voigt_2020 ([link](https://libreas.eu/ausgabe38/voigt/)).
...
Die prozentualen Anteile in der Tabelle beziehen sich ausschließlich auf Artikel, für die TDM-Informationen vorhanden sind. 
Bitte beachten Sie zudem, dass Verlage mehr als ein Format anbieten können.
