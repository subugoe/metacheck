...
Er richtet sich in erster Linie an Bibliotheken und wissenschaftliche Informationseinrichtungen. Im Mittelpunkt der Überprüfung des Open-Access-Metadaten-Schnelltests stehen die Metadaten der DOI-Registrierungsagentur Crossref, welche von den meisten wissenschaftlichen Verlagen als Metadatenservice genutzt wird [@Hendricks_2020].
...
Der Abschnitt zeigt die Anzahl der DOIs mit Metadaten in Crossref.
